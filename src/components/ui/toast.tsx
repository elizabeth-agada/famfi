    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            {action && (
              ...
              >
                {action.label}
                <svg className="inline-flex ml-2 fill-zinc-300" width="13" height="13" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg" >
        ...
        <div className="flex flex-col">
          {!disableDismiss && (
            <ToastPrimitives.Close className="mt-2.5 mr-2.5">
              <svg
